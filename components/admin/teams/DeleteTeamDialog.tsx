...
import { deleteTeam, type Team } from "@/lib/teams";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-md rounded-2xl border border-border/40 bg-card p-6 shadow-2xl">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          ...
          <strong className="text-white">{team.name}</strong>? This will also
          remove all team members. This action cannot be undone.
        </p>
